...
describe('test use of teleflows node package - Subscribers class', () => {
  ...
  test('should delete subscriber provider credentials correctly', async () => {
    ...
    await teleflow.subscribers.deleteCredentials(
  ...
  test('should unset subscriber channel credentials correctly', async () => {
    ...
    await teleflow.subscribers.unsetCredentials(
      'test-update-subscriber',
      'slack'
    );
  ...
  test('should update subscriber online status', async () => {
    ...
    await teleflow.subscribers.updateOnlineStatus(
      'test-update-subscriber',
      true
    );
  ...
  test('should mark subscriber feed message as seen', async () => {
    ...
    await teleflow.subscribers.markMessageSeen(
      'test-message-seen',
      'message-123'
    );
  ...
  test('should mark subscriber feed message as read', async () => {
    ...
    await teleflow.subscribers.markMessageRead(
      'test-message-read',
      'message-123'
    );
